...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <!--FIM DO MENU-->
     <div class="crumb_navigation"> Navigation: <a href="index.php">Home</a> &lt; <span class="current">Carrinho</span> </div>
  ...
  <!--FIM DO MENU DA ESQUERDA-->
    <div class="center_content">
      <div class="center_title_bar">Confirma��o de Carrinho</div>
       ...
       <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
    		<div class="specifications"> Total do Carrinho: <span class="blue"> R$ 3.578,00</span> </div><br />
              <div class="form_row"><a href="index.php" class="contact">Cancelar</a> <a href="login2.php" class="contact">Confirmar</a></div>
