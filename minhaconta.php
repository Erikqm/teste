  ...
  <div id="main_content">
    <div id="menu_tab">
      <div class="left_menu_corner"></div>
      	<ul class="menu">
        	...
        	<li class="divider"></li>
        	<li><a href="minhaconta.php" class="nav4">Entrar</a></li>
        	<li class="divider"></li>
        	<li><a href="login3.php" class="nav6">Administrador</a></li>
        	<li class="divider"></li>
        	<li><a href="login3.php" class="nav2">Sair</a></li>
        	</li>
      	</ul>
    ...
    <div class="left_content">
        ...
        <ul class="left_menu">
     	...
     	<li class="even"><a href="statuscliente.php">Sair</a></li>
      	</ul>
    </div>
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <table align="center" border="1" bordercolor="#000000" style="border-collapse: collapse" cellpadding="2">
          	...
          	<tr>
          		<td><a class="ggg" href="status.php">Pedido 304123</a></td>
          		<td><a class="ggg" href="status.php">Pendente</a></td>
          </tr>
          <tr>
          		<td><a class="ggg" href="status.php">Pedido 304112</a></td>
          		<td><a class="ggg" href="status.php">Cancelado</a></td>
          </tr>
          <tr>
          		<td><a class="ggg" href="status.php">Pedido 304089</a></td>
          		<td><a class="ggg" href="status.php">Conclu�do</a></td>
          </tr>
          </table>
          <br />
