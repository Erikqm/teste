...
<div id="main_container">
  ...
  <div id="main_content">
	...
	switch ($rel) {
		...
		case 2:
			include("select.php");
			$array = select("a.loginu,a.nomeus, b.codusu, sum(b.valped)","usuari a inner join pedido b","on (a.codusu=b.codusu) where b.dtpedi>='$dti 00:00:00' and b.dtpedi <='$dtf 23:59:59' group by a.loginu");
			echo "<div class='center_content'>
			...
			break;
		case 3:
			echo "SELECT * FROM USUARI E BLA BLA BLA BLA";
	}
    ?>
