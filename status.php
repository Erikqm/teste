...
<div id="main_container">
  ...
  <!--FIM DO MENU DA ESQUERDA-->
    <div class="center_content">
      <div class="center_title_bar">Informações da Compra #304123</div>
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <div class="details_big_box">
            ...
            <div class="specifications"> Quantidade: <span class="blue"> 1
</span><br /><br />
       ...
       <div class="prod_box_big">
        <div class="top_prod_box_big"></div>
        <div class="center_prod_box_big">
    		<div class="specifications"> Total da Compra: <span class="blue"> R$ 3.578,00</span> </div><br />
              </div> 
              
        <div class="bottom_prod_box_big"></div>
      </div>     
      <div class="center_title_bar">Status da Compra #304123</div>
      <div class="prod_box_big">
        <div class="top_prod_box_big"></div>
        <div class="center_prod_box_big">
          <div class="specifications"> Status: <span class="blue">Pendente (Aguardando Confirmação de Pagamento)
</span><br /><br />
              Data de Criação <span class="blue">01/06/2013 - 00:27</span>
            </div>
        </div>
        <div class="bottom_prod_box_big"></div>
      </div>    
